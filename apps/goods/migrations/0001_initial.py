# Generated by Django 2.2.16 on 2020-11-27 00:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_sn', models.CharField(default='', max_length=100, verbose_name='商品唯一货号')),
                ...
                ('goods_front_image', models.ImageField(blank=True, null=True, upload_to='media/goods/images/goods', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='', help_text='类别code', max_length=100, verbose_name='类别code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='media/images/goodsimage', verbose_name='图片')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='media/goods/images/bannerimg', verbose_name='轮播图片')),
